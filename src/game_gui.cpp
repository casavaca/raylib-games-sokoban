...
void Init() {
    ...
    g_basePng[TILE_PLAYER_E      ] = raylib::Texture("../assets/kenney_sokoban-pack/PNG/Retina/Player/player_17.png");
    g_basePng[TILE_PLAYER_S      ] = raylib::Texture("../assets/kenney_sokoban-pack/PNG/Retina/Player/player_03.png");
    g_basePng[TILE_PLAYER_W      ] = raylib::Texture("../assets/kenney_sokoban-pack/PNG/Retina/Player/player_20.png");
